...
def optimization(loss,
    ...
    if use_fp16:
        mp_optimizer = fluid.contrib.mixed_precision.decorator(optimizer, init_loss_scaling=loss_scaling)
        if dist_strategy is not None:
            dist_optimizer = fleet.distributed_optimizer(mp_optimizer, strategy=dist_strategy)
